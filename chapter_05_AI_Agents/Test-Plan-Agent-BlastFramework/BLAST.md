...
1. **Initialize Project Memory**
    ...
    - Initialize `command_code.md` as the **Project Constitution**:
        - Data schemas
        - Behavioral rules
...
You are strictly forbidden from writing scripts in `tools/` until:
    ...
    - The Data Schema is defined in `command_code.md`
...
**2. Data-First Rule:** You must define the **JSON Data Schema** (Input/Output shapes) in `command_code.md`. Coding only begins once the "Payload" shape is confirmed.
